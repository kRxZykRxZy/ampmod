...
Blockly.FieldAngle.prototype.showEditor_ = function () {
    ...
    Blockly.utils.createSvgElement(
        "line",
        {
            ...
            x2:
                Blockly.FieldAngle.HALF +
                Blockly.FieldAngle.RADIUS * Math.cos(offsetRadians),
            y2:
                Blockly.FieldAngle.HALF -
                Blockly.FieldAngle.RADIUS * Math.sin(offsetRadians),
            class: "blocklyAngleLine",
        },
        svg
    );
...
Blockly.FieldAngle.prototype.onMouseDown = function () {
    this.mouseMoveWrapper_ = Blockly.bindEvent_(
        document.body,
        "mousemove",
        this,
        this.onMouseMove
...
Blockly.FieldAngle.prototype.onMouseMove = function (e) {
    ...
    if (Blockly.FieldAngle.ROUND) {
        angle =
            Math.round(angle / Blockly.FieldAngle.ROUND) *
...
Blockly.FieldAngle.prototype.updateGraph_ = function () {
    ...
    var angleDegrees =
        (Number(this.getText()) % 360) + Blockly.FieldAngle.OFFSET;
    ...
    if (!isNaN(angleRadians)) {
        ...
        var largeFlag =
            Math.abs(angleDegrees - Blockly.FieldAngle.OFFSET) > 180 ? 1 : 0;
