...
class Scratch3MakeyMakeyBlocks {
    ...
    get KEY_TEXT_SHORT() {
        return {
            ...
            [KEY_ID_UP]: formatMessage({
                ...
                default: "up",
                description:
                    "Short name for the up arrow key on a computer keyboard.",
            }),
            [KEY_ID_RIGHT]: formatMessage({
                id: "makeymakey.rightArrowShort",
                default: "right",
                description:
                    "Short name for the right arrow key on a computer keyboard.",
            }),
            ...
            blocks: [
                ...
                },
                {
                    ...
                    text: formatMessage({
                        ...
                        description:
                            "when a sequence of keyboard keys is pressed in a specific order",
                    }),
                    blockType: BlockType.HAT,
                    arguments: {
                        SEQUENCE: {
                    ...
                    items: [
                        {
                            text: formatMessage({
                                ...
                                default: "space",
                                description:
                                    "The space key on a computer keyboard.",
                            }),
                            value: KEY_ID_SPACE,
                        },
                        {
                            text: formatMessage({
                                ...
                                default: "up arrow",
                                description:
                                    "The up arrow key on a computer keyboard.",
                            }),
                            value: KEY_ID_UP,
                        },
                        {
    ...
    addSequence(sequenceString, sequenceArray) {
        ...
        if (
            Object.prototype.hasOwnProperty.call(this.sequences, sequenceString)
        ) {
            return;
        }
