    ...
    descendInput (block, preserveStrings = false) {
        ...
        case 'operator_equals':
            return new IntermediateInput(
                ...
                this.runtime.runtimeOptions.caseSensitivity ? InputOpcode.OP_EQUALS_CS : InputOpcode.OP_EQUALS,
                InputType.BOOLEAN,
                {
        ...
        case 'data_changevariableby': {
            ...
            return new IntermediateStackBlock(StackOpcode.VAR_SET, {
                ...
                value: new IntermediateInput(InputOpcode.OP_ADD, InputType.NUMBER_OR_NAN, {
                    left: new IntermediateInput(InputOpcode.VAR_GET, InputType.ANY, {variable}).toType(
                        InputType.NUMBER
                    ),
