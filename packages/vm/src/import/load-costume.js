...
import AsyncLimiter from '../util/async-limiter.js';
import {loadSvgString, serializeSvgToString} from '@turbowarp/scratch-svg-renderer';
import {parseVectorMetadata} from '../serialization/tw-costume-import-export.js';
...
const loadCostumeFromAsset = function (costume, runtime, optVersion) {
    ...
    if (typeof costume.rotationCenterX === 'number' &&
