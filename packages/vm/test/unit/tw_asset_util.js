...
test('getByMd5ext from zip root', t => {
    ...
    AssetUtil.getByMd5ext(rt, zip, rt.storage.AssetType.SVG, '00000000000000000000000000000000.svg').then(asset => {
...
test('getByMd5ext from storage with null zip', t => {
    ...
    AssetUtil.getByMd5ext(rt, null, rt.storage.AssetType.SVG, '00000000000000000000000000000000.svg').then(asset => {
