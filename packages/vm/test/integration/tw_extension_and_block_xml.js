...
test('XML escaped in Runtime.getBlocksXML()', t => {
    ...
    */
    ...
    t.equal(block.attribs.type, 'xmltest_opcode &lt;&gt;&amp;&quot;&apos;', 'escaped block id');
    ...
    t.equal(inputShadow.attribs.type, 'xmltest_menu_input &lt;&gt;&amp;&quot;&apos;', 'escaped menu id');
...
test('XML escaped in Blocks.toXML()', async t => {
    ...
    const checkVM = () => {
        ...
        */
        ...
        t.equal(block.attribs.type, 'xmltest_opcode &lt;&gt;&amp;&quot;&apos;', 'escaped block opcode');
        t.equal(block.children.length, 3, 'block has 3 children');
