...
contextBridge.exposeInMainWorld('DesktopSettingsPreload', {
    ...
    setHardwareAcceleration: hardwareAcceleration =>
        ipcRenderer.invoke('set-hardware-acceleration', hardwareAcceleration),
    setBackgroundThrottling: backgroundThrottling =>
        ipcRenderer.invoke('set-background-throttling', backgroundThrottling),
    ...
    setExitFullscreenOnEscape: exitFullscreenOnEscape =>
        ipcRenderer.invoke('set-exit-fullscreen-on-escape', exitFullscreenOnEscape),
