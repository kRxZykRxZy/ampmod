...
const migrate = async () => {
    ...
    if (
        ...
        dialog.showMessageBoxSync({
            ...
            buttons: [translate('arm-translation.ok'), translate('arm-translation.ignore')],
            cancelId: 0,
            defaultId: 0,
            noLink: true
        }) === 0
    ...
    if (
        ...
        const result = dialog.showMessageBoxSync({
            ...
            buttons: [translate('unnecessary-legacy.ok'), translate('unnecessary-legacy.ignore')],
            cancelId: 0,
            defaultId: 0,
            noLink: true
        });
    ...
    if (
        ...
        if (
            dialog.showMessageBoxSync({
                ...
                buttons: [translate('downgrade-warning.exit'), translate('downgrade-warning.continue-anyways')],
                cancelId: 0,
                defaultId: 0,
                noLink: true
            }) === 0
