...
const TWRenderRecoloredImage = ({src, ...props}) => <img src={typeof src === 'function' ? src() : src} {...props} />;
...
export default connect(mapStateToProps, mapDispatchToProps)(TWRenderRecoloredImage);
