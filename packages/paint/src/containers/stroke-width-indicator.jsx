...
import {applyColorToSelection, applyStrokeWidthToSelection, getColorsFromSelection, MIXED} from '../helper/style-path';
...
class StrokeWidthIndicator extends React.Component {
    ...
    handleChangeStrokeWidth(newWidth) {
        ...
        if ((!this.props.strokeWidth || this.props.strokeWidth === 0) && newWidth > 0) {
            ...
            const wasNull =
                currentColorState.strokeColor === null &&
...
export default connect(mapStateToProps, mapDispatchToProps)(StrokeWidthIndicator);
