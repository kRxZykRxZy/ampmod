...
class BrushMode extends React.Component {
    constructor(props) {
        ...
        this.blob = new Blobbiness(this.props.onUpdateImage, this.props.clearSelectedItems);
    }
    componentDidMount() {
    ...
    render() {
        return (
            <BrushModeComponent isSelected={this.props.isBrushModeActive} onMouseDown={this.props.handleMouseDown} />
        );
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(BrushMode);
