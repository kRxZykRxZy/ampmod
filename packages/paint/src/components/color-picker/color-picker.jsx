...
class ColorPickerComponent extends React.Component {
    ...
    render() {
        return (
            <div className={styles.colorPickerContainer} dir={this.props.rtl ? 'rtl' : 'ltr'}>
                    ...
                    <div>
                        <div className={styles.row}>
                            <div className={styles.gradientPickerRow}>
                                ...
                                <TWRenderRecoloredImage
                                    className={classNames({
                                        [styles.inactiveGradient]: this.props.gradientType !== GradientTypes.HORIZONTAL,
                                        [styles.clickable]: true
                                    })}
                                    draggable={false}
                        ...
                        {this.props.gradientType === GradientTypes.SOLID ? null : (
                            <div className={styles.row}>
                                <div className={classNames(styles.gradientPickerRow, styles.gradientSwatchesRow)}>
                                    <div
                                        className={classNames({
                                            [styles.clickable]: true,
                                            [styles.swatch]: true,
                                        ...
                                        style={{
                                            backgroundColor:
                                                this.props.color === null || this.props.color === MIXED
                                                    ? 'white'
                                                    : this.props.color
                                        }}
                                    ...
                                    <div
                                        ...
                                        style={{
                                            backgroundColor:
                                                this.props.color2 === null || this.props.color2 === MIXED
                                                    ? 'white'
                                                    : this.props.color2
                                        }}
                ...
                <div className={styles.row}>
                    <div className={styles.rowHeader}>
                        ...
                        <TWColorReadout value={this.props.hue} onChange={this.props.onHueChange} />
                    </div>
                ...
                <div className={styles.row}>
                    <div className={styles.rowHeader}>
                        ...
                        <TWColorReadout value={this.props.saturation} onChange={this.props.onSaturationChange} />
                    </div>
                    <div className={styles.rowSlider}>
                        <Slider
                ...
                <div className={styles.row}>
                    <div className={styles.rowHeader}>
                        ...
                        <TWColorReadout value={this.props.brightness} onChange={this.props.onBrightnessChange} />
                    </div>
                    <div className={styles.rowSlider}>
                        <Slider
                ...
                <div className={styles.row}>
                    <div className={styles.rowHeader}>
                        ...
                        <TWColorReadout value={this.props.alpha} onChange={this.props.onAlphaChange} />
                    </div>
                    <div className={styles.rowSlider}>
                        <Slider
                            lastSlider
                ...
                <div className={styles.swatchRow}>
                    <div className={styles.swatches}>
                        ...
                        this.props.mode === Modes.BIT_TEXT ? null : (
                            ...
                            >
                                <img className={styles.swatchIcon} draggable={false} src={noFillIcon} />
                            </div>
                        )}
                    </div>
                    <div className={styles.swatches}>
