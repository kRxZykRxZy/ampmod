...
const ModeToolsComponent = props => {
    ...
    switch (props.mode) {
        ...
        /* falls through */
        case Modes.BIT_LINE: {
            const currentIcon = isVector(props.format)
                ? brushIcon
        ...
        case Modes.TEXT:
            return (
                <div className={classNames(props.className, styles.modeTools)}>
                    <InputGroup>
                        <FontDropdown onUpdateImage={props.onUpdateImage} onManageFonts={props.onManageFonts} />
                    </InputGroup>
                </div>
            );
        case Modes.BIT_RECT:
        ...
        default:
            ...
            return <div className={classNames(props.className, styles.modeTools)} />;
    }
};
...
export default connect(mapStateToProps, mapDispatchToProps)(injectIntl(ModeToolsComponent));
