...
const KeyboardShortcutsHOC = function (WrappedComponent) {
    class KeyboardShortcutsWrapper extends React.Component {
        constructor(props) {
            super(props);
            bindAll(this, ['handleKeyPress', 'changeToASelectMode', 'selectAll']);
        }
        ...
        render() {
            ...
            return <WrappedComponent onKeyPress={this.handleKeyPress} {...componentProps} />;
        }
    }
    ...
    return CopyPasteHOC(connect(mapStateToProps, mapDispatchToProps)(KeyboardShortcutsWrapper));
};
