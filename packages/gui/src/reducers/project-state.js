...
const getIsLoadingWithId = loadingState =>
    loadingState === LoadingState.LOADING_VM_WITH_ID || loadingState === LoadingState.LOADING_VM_NEW_DEFAULT;
...
const getIsShowingProject = loadingState =>
    loadingState === LoadingState.SHOWING_WITH_ID || loadingState === LoadingState.SHOWING_WITHOUT_ID;
...
const reducer = function (state, action) {
    ...
    switch (action.type) {
        ...
        case DONE_UPDATING:
            if (
                state.loadingState === LoadingState.AUTO_UPDATING ||
        ...
        case START_LOADING_VM_FILE_UPLOAD:
            if (
                [LoadingState.NOT_LOADED, LoadingState.SHOWING_WITH_ID, LoadingState.SHOWING_WITHOUT_ID].includes(
                    state.loadingState
                )
            ) {
                return Object.assign({}, state, {
