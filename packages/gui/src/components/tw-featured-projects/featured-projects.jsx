...
class FeaturedProjects extends React.Component {
    constructor(props) {
        super(props);
        bindAll(this, ['handleSelect', 'handleOpenProjects']);
        this.state = {
            opened: false,
            transition: true
        };
    ...
    render() {
        ...
        return (
            <div className={styles.container}>
                ...
                >
                    <StudioView id={this.props.studio} onSelect={this.handleSelect} placeholder={!opened} />
                    {opened ? null : (
                        <div className={styles.openerContainer} onClick={this.handleOpenProjects}>
