        ...
        <Box className={styles.activityArea}>
            <Box className={styles.centeredRow}>
                <div className={styles.peripheralActivity}>
                    ...
                    <img className={styles.bluetoothConnectingIcon} src={bluetoothIcon} draggable={false} />
                </div>
            </Box>
        </Box>
        <Box className={styles.bottomArea}>
            <Box className={classNames(styles.bottomAreaItem, styles.instructions)}>{props.connectingMessage}</Box>
            ...
            <div className={classNames(styles.bottomAreaItem, styles.segmentedButton)}>
                ...
                <button className={styles.connectionButton} onClick={props.onDisconnect}>
