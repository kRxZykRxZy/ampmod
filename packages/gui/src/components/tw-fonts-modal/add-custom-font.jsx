...
class AddCustomFont extends React.Component {
    constructor(props) {
        super(props);
        bindAll(this, ['handleChangeFile', 'handleChangeName', 'handleChangeFallback', 'handleFinish']);
        this.state = {
            file: null,
            url: null,
            name: '',
    ...
    handleFinish() {
        ...
        fr.onload = () => {
            ...
            const asset = storage.createAsset(storage.AssetType.Font, this.state.format, data, null, true);
                ...
                {this.state.file && (
                    <React.Fragment>
                        ...
                        <LoadTemporaryFont url={this.state.url}>
                            {family => <FontPlayground family={`${family}, ${this.state.fallback}`} />}
                        </LoadTemporaryFont>

                        <FontFallback fallback={this.state.fallback} onChange={this.handleChangeFallback} />
                    </React.Fragment>
                )}
