...
const messages = defineMessages({
    ...
    openSettingsMessage: {
        defaultMessage: 'Open program settings',
        description: 'Button to open program settings in embeds',
        id: 'amp.openSettings'
    }
});
    ...
    if (isFullScreen || isEmbedded) {
        ...
        const fullscreenButton = isFullScreen ? (
            <div className={styles.unselectWrapper}>
                <Button className={styles.stageButton} onClick={onSetStageUnFullScreen} onKeyPress={onKeyPress}>
                    <img
