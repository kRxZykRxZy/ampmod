...
class ProjectInput extends React.Component {
    constructor(props) {
        super(props);
        bindAll(this, ['handleKeyDown', 'handleChange', 'handleBlur', 'handleFocus', 'inputRef', 'tooltipRef']);
        this.state = {
    ...
    render() {
        ...
        return (
            <div ref={this.tooltipRef} data-tip={this.props.intl.formatMessage(messages.tooltip)}>
...
export default injectIntl(connect(mapStateToProps, mapDispatchToProps)(ProjectInput));
