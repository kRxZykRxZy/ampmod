...
import {activateColorPicker, deactivateColorPicker} from '../reducers/color-picker';
...
class Stage extends React.Component {
    ...
    drawDragCanvas(drawableData, x, y) {
        const {imageData, x: boundsX, y: boundsY, width: boundsWidth, height: boundsHeight} = drawableData;
...
const mapStateToProps = state => ({
    ...
    disableEditingTargetChange:
        state.scratchGui.mode.isFullScreen || state.scratchGui.mode.isEmbedded || state.scratchGui.mode.isPlayerOnly,
