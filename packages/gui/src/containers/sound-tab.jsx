    ...
    render() {
        ...
        return (
            ...
            >
                ...
                {this.props.soundRecorderVisible ? <RecordModal onNewSound={this.handleNewSound} /> : null}
...
export default errorBoundaryHOC('Sound Tab')(injectIntl(connect(mapStateToProps, mapDispatchToProps)(SoundTab)));
