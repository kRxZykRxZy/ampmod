...
import * as accentGreenOld from './accent/green-old';
...
const ACCENT_GREEN_OLD = 'green-old';
...
const ACCENT_MAP = {
    ...
    [ACCENT_GREEN_OLD]: accentGreenOld,
    [ACCENT_GREY]: accentGrey,
    [ACCENT_RAINBOW]: accentRainbow
};
const ACCENT_DEFAULT = process.env.ampmod_mode === 'canary' ? ACCENT_RED : ACCENT_GREEN;
...
class Theme {
    ...
    getGuiColors() {
        return defaultsDeep(
            {},
            this.gui === 'high-contrast' || this.gui === 'custom' ? null : ACCENT_MAP[this.accent].guiColors,
