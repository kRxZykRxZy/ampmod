...
import {defaultProjectId, getIsFetchingWithoutId, setProjectId} from '../reducers/project-state';
...
const HashParserHOC = function (WrappedComponent) {
    class HashParserComponent extends React.Component {
        ...
        componentDidUpdate(prevProps) {
            ...
            if (this.props.isFetchingWithoutId && !prevProps.isFetchingWithoutId) {
                ...
                history.pushState('new-project', 'new-project', window.location.pathname + window.location.search);
            }
        }
    ...
    return connect(mapStateToProps, mapDispatchToProps, mergeProps)(HashParserComponent);
};
