...
const messages = defineMessages({
    ...
    sensing_lastkeypressed: {
        ...
        description: 'Label for the last key pressed monitor when shown on the stage',
        id: 'amp.opcodeLabels.lastkeypressed'
    },
    sensing_mousebuttondown_primary: {
        defaultMessage: 'primary mouse button down?',
        description: 'Label for the primary mouse button down monitor when shown on the stage',
        id: 'amp.opcodeLabels.mbdPrimary'
    },
    sensing_mousebuttondown_middle: {
        defaultMessage: 'middle mouse button down?',
        description: 'Label for the middle mouse button down monitor when shown on the stage',
    ...
    _refreshOpcodeMap() {
        ...
        this._opcodeMap.sensing_mousebuttondown.labelFn = params => {
            switch (params.MOUSEBUTTONMENU.toLowerCase()) {
                case '0':
                    return this._translator(messages.sensing_mousebuttondown_primary);
                case '1':
                    return this._translator(messages.sensing_mousebuttondown_middle);
                case '2':
                    return this._translator(messages.sensing_mousebuttondown_secondary);
            }
        };
