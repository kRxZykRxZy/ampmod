...
describe('Sound Editor Component', () => {
    ...
    test('delete button appears when selection is not null', () => {
        const wrapper = mountWithIntl(<SoundEditor {...props} trimEnd={0.75} trimStart={0.25} />);
    ...
    test('undo and redo buttons can be disabled by canUndo/canRedo', () => {
        let wrapper = mountWithIntl(<SoundEditor {...props} canUndo canRedo={false} />);
        ...
        wrapper = mountWithIntl(<SoundEditor {...props} canRedo canUndo={false} />);
    ...
    test.skip('undo/redo buttons call the correct callback', () => {
        const wrapper = mountWithIntl(<SoundEditor {...props} canRedo canUndo />);
